...
function defaultSite() {
  return {
    ...
    seo: {
      ...
      googleVerification: '',
      bingVerification: '',
      // The Wikidata item for the person this site is about, if one exists.
      wikidata: ''
    },
    nav: [
      ...
      { id: 'nav-play', label: 'Play', href: '/play', visible: true }
    ],
    home: {
    ...
    contact: {
      kicker: 'Contact',
      title: 'New message',
      intro: 'Dates, venues, press — all of it goes here.',
      to: 'booking@taylordrew.com',
      subject: 'Booking enquiry',
      placeholder: 'Who you are, the date, the venue, and anything else worth knowing.',
      sendLabel: 'Send'
    },
    footer: {
