...
function jsonLd(site, { origin, canonical, title, current }) {
  ...
  const person = {
    ...
    url: `${origin}/`,
    // The home page is where this person is described; saying so is what stops
    // a crawler treating the three pages as three different subjects.
...
module.exports = { renderHome, renderAbout, renderLinks, renderNotFound, llmsTxt, faviconSvg, webManifest, esc };
