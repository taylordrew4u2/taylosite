 ...
 */
function jsonLd(site, { origin, canonical, title, description, current }) {
  ...
  const pageTypes = { '/': 'WebPage', '/about': 'ProfilePage', '/links': 'CollectionPage', '/reels': 'CollectionPage', '/photos': ['CollectionPage', 'ImageGallery'] };
  const webPage = {
...
${origin ? jsonLd(site, { origin, canonical, title, description, current }) : ''}
...
module.exports = { renderHome, renderAbout, renderShows, renderLinks, renderReels, renderReelTiles, wallReels, renderPhotos, visiblePhotos, renderPlay, renderContact, renderNotFound, llmsTxt, faviconSvg, webManifest, esc };
