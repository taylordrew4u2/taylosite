 ...
 * The boot.
 *
 * Turning the machine on was three screens, and this is all three: the black
 * self-test with the memory counting up and the drives being found, the black
 * logo screen with the blue blocks marching under the name, then the blue
 * welcome screen with your picture on it — and only then the desktop. It is
 * hidden until desktop.js shows it, once a visit, and everything on it is
 * decoration: the crawler and the screen reader get the page underneath.
 */
function renderBoot(site, name) {
  const place = site.brand.location ? esc(site.brand.location) : 'the computer room';
  const post = [
    'Modular BIOS v4.51PG, An Energy Star Ally',
    'Copyright (C) 1984-2001, Comedy Operating System, Inc.',
    '',
    'PENTIUM II-MMX CPU at 300MHz',
    'Memory Test :  <span class="boot-mem">0</span>K OK',
    '',
    'Plug and Play BIOS Extension v1.0A',
    'Detecting IDE Primary Master   ... COMEDY-DRIVE 4.3GB',
    'Detecting IDE Primary Slave    ... None',
    'Detecting IDE Secondary Master ... CD-ROM 24X',
    'Detecting IDE Secondary Slave  ... None',
    'Detecting jokes                ... 1,024 found',
    '',
  ...
  <div class="boot" hidden data-stage="post">
    <div class="boot-post" aria-hidden="true">
      ...
      <p class="boot-post-foot">Press DEL to enter SETUP<span>${esc(place)}</span></p>
    </div>
    <div class="boot-os" aria-hidden="true">
      <div class="boot-os-mark">
        <span class="boot-flag"><i></i><i></i><i></i><i></i></span>
        <p class="boot-name">${esc(name)}</p>
        <p class="boot-sub">comedy operating system</p>
      </div>
      <div class="boot-bar"><span></span></div>
      <p class="boot-os-foot"><span>Copyright &copy; Comedy Operating System</span><span>Home Edition</span></p>
    </div>
    <div class="boot-welcome" aria-hidden="true">
      <div class="boot-welcome-left">
        <p class="boot-welcome-brand">${esc(name)}</p>
        <p class="boot-welcome-hint">To begin, wait for the desktop</p>
      </div>
      <div class="boot-welcome-right">
        <div class="boot-user">
          <span class="boot-avatar"><i></i></span>
          <span class="boot-user-text"><b>${esc(name)}</b><small>Loading your personal settings...</small></span>
        </div>
