...
/*
 * Desktop icons, drawn the way the machine drew them: 32 pixels square, flat
 * fills from a sixteen-colour palette, a black outline around everything, and
 * no gradient, shadow or rounded corner anywhere. Every coordinate is a whole
 * number so each edge lands on a pixel boundary — with `shape-rendering:
 * crispEdges` in the stylesheet, that is what keeps them hard rather than
 * smoothed into the modern thing they were before.
 */
const ICON_ART = {
  // My Computer: a CRT in beige, showing the teal every machine booted to.
  monitor: `<rect x="3" y="4" width="26" height="19" fill="#c0c0c0"/>
    <rect x="25" y="5" width="3" height="17" fill="#808080"/>
    <rect x="5" y="6" width="19" height="14" fill="#008080"/>
    <rect x="6" y="7" width="7" height="4" fill="#3fd0d0"/>
    <rect x="13" y="23" width="6" height="3" fill="#c0c0c0"/>
    <rect x="8" y="26" width="16" height="3" fill="#c0c0c0"/>
    <rect x="3" y="4" width="26" height="19" fill="none" stroke="#000"/>
    <rect x="8" y="26" width="16" height="3" fill="none" stroke="#000"/>
    <rect x="13" y="23" width="6" height="3" fill="none" stroke="#000"/>`,

  // A text file, with the dog-eared corner that meant "document".
  page: `<path d="M7 3h11l7 7v19H7z" fill="#fff" stroke="#000"/>
    <path d="M18 3l7 7h-7z" fill="#c0c0c0" stroke="#000"/>
    <rect x="10" y="14" width="12" height="1" fill="#000080"/>
    <rect x="10" y="17" width="12" height="1" fill="#000080"/>
    <rect x="10" y="20" width="12" height="1" fill="#000080"/>
    <rect x="10" y="23" width="8" height="1" fill="#000080"/>`,

  // A strip of film for the clips.
  film: `<rect x="3" y="6" width="26" height="20" fill="#303030" stroke="#000"/>
    <rect x="5" y="8" width="3" height="3" fill="#fff"/>
    <rect x="10" y="8" width="3" height="3" fill="#fff"/>
    <rect x="15" y="8" width="3" height="3" fill="#fff"/>
    <rect x="20" y="8" width="3" height="3" fill="#fff"/>
    <rect x="24" y="8" width="3" height="3" fill="#fff"/>
    <rect x="5" y="21" width="3" height="3" fill="#fff"/>
    <rect x="10" y="21" width="3" height="3" fill="#fff"/>
    <rect x="15" y="21" width="3" height="3" fill="#fff"/>
    <rect x="20" y="21" width="3" height="3" fill="#fff"/>
    <rect x="24" y="21" width="3" height="3" fill="#fff"/>
    <rect x="5" y="13" width="22" height="6" fill="#c0c0c0" stroke="#000"/>`,

  // The manila folder, tab and all.
  folder: `<path d="M3 7h10l2 3h14v17H3z" fill="#e0a63a" stroke="#000"/>
    <path d="M3 12h26v15H3z" fill="#ffcc55" stroke="#000"/>
    <rect x="3" y="12" width="26" height="2" fill="#e0a63a"/>`,

  // A joystick, which is what a game looked like before it looked like a pad.
  joystick: `<rect x="5" y="20" width="22" height="8" fill="#c0c0c0" stroke="#000"/>
    <rect x="15" y="9" width="3" height="11" fill="#404040" stroke="#000"/>
    <circle cx="16" cy="7" r="4" fill="#ff0000" stroke="#000"/>
    <rect x="21" y="22" width="4" height="4" fill="#ff0000" stroke="#000"/>
    <rect x="7" y="22" width="4" height="4" fill="#808000" stroke="#000"/>`,

  // Mail, sealed.
  envelope: `<rect x="3" y="8" width="26" height="17" fill="#fff" stroke="#000"/>
    <path d="M3 8h26L16 18z" fill="#e4e4e4" stroke="#000"/>
    <path d="M3 25l9-8M29 25l-9-8" stroke="#000" fill="none"/>`,

  // A cog, the way every system file that would not open was drawn.
  gear: `<g fill="#c0c0c0" stroke="#000">
      <rect x="13" y="3" width="6" height="26"/>
      <rect x="3" y="13" width="26" height="6"/>
      <g transform="rotate(45 16 16)"><rect x="13" y="3" width="6" height="26"/><rect x="3" y="13" width="26" height="6"/></g>
      <circle cx="16" cy="16" r="9"/>
    </g>
    <circle cx="16" cy="16" r="3" fill="#808080" stroke="#000"/>`
};

/* The white badge with the black arrow that marked a shortcut, not the thing. */
const SHORTCUT_BADGE = `<rect x="1" y="22" width="9" height="9" fill="#fff" stroke="#000"/>
  <path d="M4 29l4-4" stroke="#000" stroke-width="2" fill="none"/>
  <path d="M5 24h4v4z" fill="#000"/>`;
...
function renderShell(site, current) {
  ...
  <div class="boot" hidden>
    <p class="boot-name">${esc(name)}</p>
    <p class="boot-sub">comedy operating system</p>
...
<!-- The desktop skin. It loads last so it can re-point the theme's neutral
     variables; the accent stays whatever the served scheme says. -->
...
module.exports = { renderHome, renderAbout, renderLinks, renderReels, renderPlay, renderContact, renderNotFound, llmsTxt, faviconSvg, webManifest, esc };
