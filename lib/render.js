  ...
  return `
      <span class="boot-logo">
        ...
        <span class="boot-wordmark">
          ...
          <span class="boot-wm-edition">Home Edition</span>
        </span>
      </span>`;
}
...
function renderBoot(site, name) {
  const post = [
    ...
    '',
    'TAYLOR DREW ACPI BIOS Revision 1012',
    '',
    'Intel Pentium II 350MHz Processor',
    'Memory Test :  <span class="boot-mem">0</span>K OK',
    '',
    'Plug and Play BIOS Extension v1.0A',
    'Copyright (C) 2001, Comedy Software, Inc.',
    'Detecting HDD Primary Master  ... COMEDY WD84AA',
    'Detecting HDD Primary Slave   ... None',
    'Detecting HDD Secondary Master... CD-ROM CDU4811',
    'Detecting HDD Secondary Slave ... None',
    'Detecting Jokes               ... 1024 Found'
  ]
  ...
  <div class="boot" hidden data-stage="post">
    <div class="boot-post" aria-hidden="true">
      ...
      <p class="boot-post-foot"><span>Press DEL to enter SETUP</span><span>09/11/01-i440BX-COMEDY-2A69KA0IC-00</span></p>
    </div>
    <div class="boot-os" aria-hidden="true">
      ${bootLogo(name, 'os')}
      <div class="boot-bar"><span></span></div>
      <p class="boot-os-copy">Copyright &copy; ${esc(name)}</p>
    ...
    <div class="boot-welcome" aria-hidden="true">
      <div class="boot-welcome-mid">
        <div class="boot-welcome-left">
          ${bootLogo(name, 'wel')}
          <p class="boot-welcome-hint">To begin, click your user name</p>
        </div>
      ...
      <div class="boot-welcome-foot">
        <span class="boot-poweroff"><i></i>Turn off computer</span>
        <span class="boot-welcome-note">After you log on, you can add or change accounts.<br>Just go to Control Panel and click User Accounts.</span>
      </div>
    </div>
